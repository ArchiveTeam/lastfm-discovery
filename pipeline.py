...
project = Project(
    ...
    project_html="""
        ...
        <h2>last.fm users discovery phase.
        <span class="links">
             <a href="http://www.last.fm/">Website</a> &middot;
             <a href="http://tracker.archiveteam.org/lastfmdisco/">Leaderboard</a>
             <a href="http://archiveteam.org/index.php?title=Last.fm">Wiki</a> &middot;
         </span>
        </h2>
        <p>This is the user profiles discovery phase</p>
    """,
...
pipeline = Pipeline(
    ...
    GetItemFromTracker("http://%s/%s" % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix="lastfmdisco"),
