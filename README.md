...
### For Debian/Ubuntu:
    ...
    pip install seesaw requests
    su -c "cd /home/archiveteam; git clone https://github.com/ArchiveTeam/lastfm-discovery.git; cd lastfm-discovery;" archiveteam
    screen su -c "cd /home/archiveteam/lastfm-discovery/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam
    [... ctrl+A D to detach ...]
...
**There is a known issue with some packaged versions of rsync. If you get errors during the upload stage, lastfm-discovery will not work with your rsync version.**
...
6. `screen su -c "cd /home/archiveteam/lastfm-discovery/; run-pipeline pipeline.py --concurrent 2 --address '127.0.0.1' YOURNICKHERE" archiveteam`
